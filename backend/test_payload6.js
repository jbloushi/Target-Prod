...
async function run() {
        ...
        content: {
            ...
            exportDeclaration: {
                lineItems: [{
                    ...
                    commodityCodes: [{ typeCode: 'outbound', value: '33030000' }],
                ...
                exportReason: 'Sale',
                exportReasonType: 'permanent',
                payerOfVAT: 'receiver', // Another thing to possibly check based on user mention of "international with duties/taxes applicable"
            }
        }
    };
    ...
    try {
        ...
        fs.writeFileSync('dhl_err6.json', JSON.stringify(err.response?.data, null, 2));
        console.log("ERROR written to dhl_err6.json");
    }
}
run();
