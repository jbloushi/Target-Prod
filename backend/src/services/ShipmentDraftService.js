        ...
        const shipment = await prisma.shipment.create({
            data: {
                ...
                origin: { 
                    ...
                    exportReason: cleanData.exportReason || null,
                    remarks: cleanData.remarks || cleanData.invoiceRemarks || null,
                    shipperAccount: cleanData.shipperAccount,
                    payerOfVat: cleanData.payerOfVat || 'receiver',
                    gstPaid: cleanData.gstPaid || false,
                    pickupRequired: cleanData.pickupRequired || false,
                    ...
                    optionalServiceCodes: cleanData.optionalServiceCodes || [],
                    billingCurrency: cleanData.billingCurrency || cleanData.currency || 'KWD'
                },
