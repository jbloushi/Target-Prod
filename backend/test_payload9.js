...
async function run() {
        ...
        content: {
            ...
            exportDeclaration: {
                lineItems: [{
                    ...
                    commodityCodes: [{ typeCode: 'inbound', value: '33030000' }], // INBOUND
    ...
    try {
        ...
        fs.writeFileSync('dhl_err9.json', JSON.stringify(err.response?.data, null, 2));
        console.log("ERROR written to dhl_err9.json");
    }
}
run();
