...
async function run() {
        ...
        content: {
            ...
            exportDeclaration: {
                lineItems: [{
                    ...
                    commodityCodes: [{
                        typeCode: 'harmonizedSystem', // Let's try harmonizedSystem exactly as we did before, maybe the schema changed or we misread the error
                        value: '33030000'
                    }],
    ...
    try {
        ...
        console.log("harmonizedSystem SUCCESS:", res.status);
    } catch (err) {
