...
async function run() {
        ...
        content: {
            ...
            exportDeclaration: {
                lineItems: [{
                    ...
                    commodityCodes: [
                        { typeCode: 'outbound', value: '33030000' },
                        { typeCode: 'inbound', value: '33030000' }
                    ],
    ...
    try {
        ...
        fs.writeFileSync('dhl_err10.json', JSON.stringify(err.response?.data, null, 2));
        console.log("ERROR written to dhl_err10.json");
    }
}
run();
