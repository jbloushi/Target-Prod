...
async function run() {
        ...
        content: {
            ...
            exportDeclaration: {
                lineItems: [{
                    ...
                    // USER SAID: Content.exportDeclaration.lineItems[].commodityCode
                    // and content.exportDeclaration.lineItems[].countryOfOrigin
                    commodityCode: '33030000',
    ...
    try {
        ...
        fs.writeFileSync('dhl_err3.json', JSON.stringify(err.response?.data, null, 2));
        console.log("ERROR written to dhl_err3.json");
    }
}
run();
