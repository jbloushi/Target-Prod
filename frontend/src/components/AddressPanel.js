...
import {
    ...
    Divider, IconButton, Tooltip, Collapse, Autocomplete, alpha, useTheme, Stack
} from '@mui/material';
                ...
                <Stack spacing={3.5}>
                    ...
                    <Box sx={{ p: 3, borderRadius: 4, bgcolor: 'surface-container-high', minHeight: 390 }}>
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={6}>
                                <TextField fullWidth size="small" label="Postal Index" value={value.postalCode || ''} onChange={(e) => updateField('postalCode', e.target.value)} required={isFieldRequired('postalCode')} disabled={disabled} />
                            </Grid>
                            <Grid item xs={6}>
                                <FormControl fullWidth size="small">
