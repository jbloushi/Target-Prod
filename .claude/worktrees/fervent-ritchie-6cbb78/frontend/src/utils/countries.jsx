/**
 * Comprehensive list of countries with ISO 3166-1 alpha-2 codes, emoji flags, and dial codes.
 */
export const countries = [
    ...
    { code: 'PS', name: 'Palestinian Territory', flag: '🇵🇸', dialCode: '+970' },
    ...
    { code: 'VG', name: 'Virgin Islands, British', flag: '🇻🇬', dialCode: '+1-284' },
